...
int main()
{
	...
	iguales=strcmp(contacto1.email, contacto2.email);//strcmp devuelve 0 si son iguales
	if(iguales==0)
	{
		printf("Ambos usuarios tienen el mismo email\n");
	}
	else
	{
		printf("No coinciden los emails\n");
	}
}
